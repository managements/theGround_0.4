    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-xs-5 text-right m-b-30">
                <a href="{{ route('provider.edit',compact('company','deal')) }}" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Edit Profile</a>
                <a href="{{ route('provider.destroy',compact('company','deal')) }}" class="btn btn-primary rounded"
                   onclick="event.preventDefault();
                                                     document.getElementById('delete-provider').submit();">
                    <i class="fa fa-plus"></i> Delete
                </a>

                <form id="delete-provider" action="{{ route('provider.destroy',compact('company','deal')) }}" method="POST" style="display: none;">
                    @csrf
                    @method('delete')
                </form>
             </div>
